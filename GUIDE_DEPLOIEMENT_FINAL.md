...
```bash
# Télécharger le code
curl -L "https://kwezi-android.preview.emergentagent.com/api/download/code" -o kwezi-frontend-code-final.tar.gz

# Télécharger les audios
curl -L "https://kwezi-android.preview.emergentagent.com/api/download/audio" -o kwezi-audio-final.tar.gz
