...
```
https://langapp-debug.preview.emergentagent.com:9000
```
...
```
https://langapp-debug.preview.emergentagent.com/api/download/code
```

### 📥 Fichiers audio (31 MB)
```
https://langapp-debug.preview.emergentagent.com/api/download/audio
```
...
```bash
# Télécharger le code
wget https://langapp-debug.preview.emergentagent.com/api/download/code -O kwezi-frontend-code.tar.gz

# Télécharger l'audio
wget https://langapp-debug.preview.emergentagent.com/api/download/audio -O kwezi-audio.tar.gz
```
...
```bash
# Télécharger le code
curl -L https://langapp-debug.preview.emergentagent.com/api/download/code -o kwezi-frontend-code.tar.gz

# Télécharger l'audio
curl -L https://langapp-debug.preview.emergentagent.com/api/download/audio -o kwezi-audio.tar.gz
```
