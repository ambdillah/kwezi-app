...
```
https://kwezi-edu.preview.emergentagent.com:9000
```
...
```
https://kwezi-edu.preview.emergentagent.com/api/download/code
```

### 📥 Fichiers audio (31 MB)
```
https://kwezi-edu.preview.emergentagent.com/api/download/audio
```
...
```bash
# Télécharger le code
wget https://kwezi-edu.preview.emergentagent.com/api/download/code -O kwezi-frontend-code.tar.gz

# Télécharger l'audio
wget https://kwezi-edu.preview.emergentagent.com/api/download/audio -O kwezi-audio.tar.gz
```
...
```bash
# Télécharger le code
curl -L https://kwezi-edu.preview.emergentagent.com/api/download/code -o kwezi-frontend-code.tar.gz

# Télécharger l'audio
curl -L https://kwezi-edu.preview.emergentagent.com/api/download/audio -o kwezi-audio.tar.gz
```
